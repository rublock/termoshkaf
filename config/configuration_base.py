...
DATA_MAP: typing.Final[dict] = {
    "TEMP_MAX_LEVEL": [350, 'Максимальная температура'],  # Максимальная температура (умножено на 10) Диапазон: -400...600 ºС, По умолчанию 400
    "TEMP_MIN_LEVEL": [110, 'Минимальная температура'],  # Минимальная температура (умножено на 10) Диапазон: -400...600 ºС, По умолчанию 100
    "HUMID_MAX_LEVEL": [650, 'Максимальная относительная влажность'],  # Максимальная относительная влажность (умножено на 10) Диапазон 100...900 %, По умолчанию 800
    ...
    "HUMID_ALARM_LEVEL": [900, 'Порог аварийной влажности'],  # Порог аварийной влажности (умножено на 10) 60...990 %, По умолчанию 900
    ...
    "FAN_HYST": [50, 'Гистерезис температуры включения вентилятора'],  # Гистерезис температуры включения вентилятора х10, 10...100 ºС, По умолчанию 50
    "HEAT_HYST": [50, 'Гистерезис температуры включения нагрева'],  # Гистерезис температуры включения нагрева х10, 10...100 ºС, По умолчанию 50
