...
DATA_MAP: typing.Final[dict] = {
    "TEMP_MAX_LEVEL": 350,  # Максимальная температура (умножено на 10) Диапазон: -400...600 ºС, По умолчанию 400
    "TEMP_MIN_LEVEL": 110,  # Минимальная температура (умножено на 10) Диапазон: -400...600 ºС, По умолчанию 100
    "HUMID_MAX_LEVEL": 650,  # Максимальная относительная влажность (умножено на 10) Диапазон 100...900 %, По умолчанию 800
    ...
    "OTP_HYST": 100,  # Гистерезис температуры включения АО х10, 10...100 ºС, По умолчанию 50
